...
export const NEW_TRACK_ADDED = `${NAME}/NEW_TRACK_ADDED`;
export const NOTE_ADDED = `${NAME}/NOTE_ADDED`;
...
export const SONG_SET = `${NAME}/SONG_SET`;
export const SONG_SHORTENED = `${NAME}/SONG_SHORTENED`;
export const TRACK_DELETED_BY_ID = `${NAME}/TRACK_DELETED_BY_ID`;
