...
export function initialize() {
  return (dispatch) => {
    dispatch(registerShortcuts([
      ...
      [notes.actions.changeSelectedSize({ x: 0, y: -1 }), ['ctrl+up', 'meta+up']],
      [notes.actions.changeSelectedSize({ x: 1, y: 0 }), ['ctrl+right', 'meta+right']],
      [notes.actions.changeSelectedSize({ x: 0, y: 1 }), ['ctrl+down', 'meta+down']],
      [notes.actions.changeSelectedSize({ x: -1, y: 0 }), ['ctrl+left', 'meta+left']],
