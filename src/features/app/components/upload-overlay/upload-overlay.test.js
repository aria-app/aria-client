...
describe('UploadOverlay Component', () => {
  ...
  it('should invoke on file drag cancel event when dragged file leaves');
  it('should invoke on file drop event with files when files are dropped');
  it('should invoke on file drag cancel event when dropped files are empty');
